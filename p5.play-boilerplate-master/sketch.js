...
function setup() {
  ...
  player2.scale = 0.5;
  player2.setCollider("rectangle",0,0,200,600)
...
if(player2.x <= player.x+50 && player2.x>50){
  player2.addImage(compimg3);
  life = life-0.25;
 punch.play();
}
...
function stoppunch(){
  if(player.x-player2.x<player2.width/2+player.width/2
     && player2.x-player.x<player2.width/2+player.width/2
     && player.y-player2.y<player2.height/2+player.height/2
     && player2.y-player.y<player2.height/2+player.height/2){
